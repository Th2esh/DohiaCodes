...
def tbicp(outer_idx,fieldsx):
    ...
    dqm_str = 'app_key23036663fields'+str(fieldsx)+'methodtaobao.items.custom.getouter_id'+str(outer_idx)+'session6100702294147e841d7715eb8a2b55033caa6e780b31a34114141735sign_methodmd5timestamp'+str(timestamp)+'v2.0'
